class User < ApplicationRecord
  ...
  # Must be unique. Must be a valid email. Must be the same as the email. (FALTA VALID EMAIL)
  # validates :email, 
  ...
  # At least 8 characters. Must contain at least 1 number. Must the same as the password. (FALTA 1+ NUMEROS)
  # validates :password, 
  #           length: { minimum: 8 }, 
